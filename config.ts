...
const config = {
  // REQUIRED
  appName: 'Rituals Quest',
  // REQUIRED: a short description of your app for SEO tags (can be overwritten)
  appDescription: 'Discover and track your daily rituals for a better life.',
  ...
  resend: {
    ...
    // Using Resend's development email - this works without domain verification
    // For production, replace with your verified domain: noreply@yourdomain.com
    fromNoReply: process.env.RESEND_EMAIL,
  },
  colors: {
