      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-nav-bg-light border-t border-gray-200 z-50">
        <div className="flex justify-around items-center h-24 px-4">
          ...
          >
            <div
              className={`p-2 px-5 rounded-xl transition-all duration-200 ${
                isActive('/dashboard') ? 'bg-nav-icon-bg-home scale-110' : 'bg-transparent'
              }`}
            >
              <span
            ...
            <span className={`text-sm ${isActive('/dashboard') ? 'text-nav-icon-home' : 'text-gray-400'}`}>Home</span>
          </button>
          ...
          >
            <div
              className={`p-2 px-5 text-xl rounded-xl transition-all duration-200 ${
                isActive('/rituals') ? 'bg-nav-icon-bg-progress scale-110' : 'bg-transparent'
              }`}
            >
              <span
                className={`w-5 h-5 text-xl  transition-colors duration-200 ${
                  isActive('/rituals') ? 'text-nav-icon-progress' : 'text-gray-400'
                }`}
              >
                🧘
              </span>
            ...
            <span className={`text-sm ${isActive('/rituals') ? 'text-nav-icon-progress' : 'text-gray-400'}`}>
              Progress
            </span>
          </button>
          ...
          >
            <div
              className={`p-2 px-5 rounded-xl transition-all duration-200 ${
                isActive('/streaks') ? 'bg-nav-icon-bg-streaks scale-110' : 'bg-transparent'
              }`}
            >
              <span
                className={`w-5 h-5 text-xl transition-colors duration-200 ${
                  isActive('/streaks') ? 'text-nav-icon-progress' : 'text-gray-400'
                }`}
              >
                🔥
              </span>
            </div>
            <span className={`text-sm ${isActive('/streaks') ? 'text-nav-icon-streaks' : 'text-gray-400'}`}>
              Streaks
            </span>
          </button>
          ...
          >
            <div
              className={`p-2 px-5 rounded-xl transition-all duration-200 ${
                isActive('/account') ? 'bg-nav-icon-bg-profile scale-110' : 'bg-transparent'
              }`}
            >
              <span
                className={`w-5 h-5  text-xl transition-colors duration-200 ${
            ...
            <span className={`text-sm ${isActive('/account') ? 'text-nav-icon-profile' : 'text-gray-400'}`}>
              Profile
            </span>
          </button>
        </div>
      ...
      {session?.user && (
        <aside className="hidden md:flex fixed left-0 top-0 h-screen w-20 lg:w-64 bg-nav-bg-light border-r border-gray-200 flex-col py-6 z-50">
          <div className="px-4 mb-8">
            <h1 className="text-xl lg:text-2xl font-bold text-text-light lg:block hidden">RitualsQuest</h1>
          ...
          <nav className="flex-1 px-3 space-y-2">
            <button
              ...
              className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-200 ${
                isActive('/dashboard') ? 'bg-nav-icon-bg-home text-nav-icon-home' : 'text-gray-600 hover:bg-blue-100'
              }`}
            >
            ...
            <button
              onClick={() => router.push('/streaks')}
              className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-200 ${
                isActive('/streaks') ? 'bg-red-200 text-red-900' : 'text-gray-600 hover:bg-red-100'
              }`}
            >
            ...
            <button
              onClick={() => router.push('/rituals')}
              className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-200 ${
                isActive('/rituals') ? 'bg-violet-200 color-main' : 'text-gray-600 hover:bg-violet-100'
              }`}
            >
            ...
            <button
              onClick={() => router.push('/account')}
              className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-200 ${
                isActive('/account') ? 'bg-gray-200 text-gray-900' : 'text-gray-600 hover:bg-gray-100'
              }`}
            >
          ...
          <div className="px-3 mt-auto">
            <div className="p-4 bg-gradient-to-br bg-main rounded-xl text-white font-medium hidden items-center gap-3 sm:flex">
              ...
              <div>
                <p className="text-sm font-semibold text-white mb-1" onClick={() => router.push('/rituals?mode=new')}>
                  New Ritual
                </p>
